      ...
      modifiers: {
        ...
        flip: {
          ...
          fn: function (p, m) {
            ...
            if (p.flipped && p.placement === p.originalInternship) return p;
            var g = Gt(
                p.instance.popper,
              ...
              return function () {
                if (!this.state.isDestroyed) {
                  ...
                  (t.offsets.reference = Jt(
                    ...
                    (t.originalInternship = t.placement),
  ...
  var wn = "tooltip",
    ...
    qn = (function () {
      ...
      return (
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            p(o).data(this.constructor.DATA_KEY, this),
              ...
              (this._popper = new be(this.element, o, {
                ...
                modifiers: {
                  offset: this._getOffset(),
                  flip: { behavior: this.config.fallbackInternship },
                  arrow: { element: Fn },
                  preventOverflow: { boundariesElement: this.config.boundary },
                },
                onCreate: function (t) {
                  t.originalInternship !== t.placement &&
                    e._handlePopperInternshipChange(t);
                },
                onUpdate: function (t) {
                  return e._handlePopperInternshipChange(t);
                },
              })),
              p(o).addClass(jn),
              "ontouchstart" in document.documentElement &&
        ...
        (t._handlePopperInternshipChange = function (t) {
          var e = t.instance;
          (this.tip = e.popper),
            this._cleanTipClass(),

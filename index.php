...
if (isset($_POST['save1'])) {
	$crs1 = $_POST['course1'];
	$sql1 = "DELETE FROM stud_course where sid={$_SESSION['uid']} and courseid='$crs1'";
...
if (isset($_POST['save2'])) {
	$crs2 = $_POST['course2'];
	$gde2 = $_POST['grade2'];
	$sql2 = "UPDATE STUD_COURSE SET GRADE=" . $gde2 . " where sid={$_SESSION['uid']} and courseid='$crs2'";
		...
		<div class="row flex-xl-nowrap">
				...
				<div class="card">
					<div class="card" style="padding: 1rem;background-color:#b866ff; color: white;">
						...
						if ($result11 && mysqli_num_rows($result11) > 0) {
							echo ('<p class="card-text"><b>Internship Status: </b>');
							echo "Placed";
							echo ('</p>');
			...
			<main role="main" class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 content">
				...
				<div class="row">
						...
						<div class="modal-dialog" id="m" role="document">
							<div class="modal-content" id="mc">
								<div class="modal-header" id="mh">
									<h5 class="modal-title" id='ch'>Add Course</h5>
					...
					<button type='button' class='btn btn-info col-2 m-2' id='rBtn' <?php if ($result11->num_rows > 0) { ?> disabled="disabled" <?php } ?>>Remove Course</button>
					<div id="myModal1" class="modal">
						<div class="modal-dialog" id="m1" role="document">
							<div class="modal-content" id="mc1">
								<div class="modal-header" id="mh1">
									<h5 class="modal-title" id='ch1'>Remove Course</h5>
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span id="rClose" class="close">&times;</span>
									</button>
								</div>
								...
								<form method="POST" id="f1">
									...
									<div class="modal-footer">
										...
										<script type="text/javascript">
											...
											var btn1 = document.getElementById("rBtn");
											var span1 = document.getElementById("rClose");
					...
					<div id="myModal2" class="modal">
						<div class="modal-dialog" id="m2" role="document">
							<div class="modal-content" id="mc2">
								<div class="modal-header" id="mh2">
									<h5 class="modal-title" id='ch2'>Edit Course Grade</h5>
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span id="gClose" class="close">&times;</span>
									</button>
								</div>
								...
								<form method="POST" id="f2">
									<div class="modal-body" id="mb2">
										...
										$query1 = "select * from course where courseid in(select courseid from stud_course where sid={$_SESSION['uid']}) order by name asc";
										$result1 = mysqli_query($con, $query1);
										echo "<select name='course2' id='course2'>";
										while ($queryRow1 = $result1->fetch_row()) {
											echo '<option value="' . $queryRow1[0] . '">' . $queryRow1[1] . '</option>';
										}
										echo "</select>";
										...
										<?php
										echo "<label for='.gra.'>Grade: </label>";
										echo "<select name='grade2' id='grade2'>";
									...
									<div class="modal-footer">
										...
										<script type="text/javascript">
											...
											var btn2 = document.getElementById("gBtn");
											var span2 = document.getElementById("gClose");

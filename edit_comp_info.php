                ...
                <div class="col-8">
                    <form method="POST" action="">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <button type='button' class='col-2 me-1 btn btn-info' id='addBtn'>Add Contact</button>
                                ...
                                <button type='button' class='col-2 me-1 btn btn-info' id='delBtn'>Delete Contact</button>
